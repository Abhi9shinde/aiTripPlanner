  ...
  return (
    <div className="sm:px-10 md:px-32 lg:px-56 xl:px-72 px-5 mt-10">
      <h2 className="font-bold text-3xl">
        Share Your Travel Preferences and Let Us Curate Your Perfect Journey!
        🌴🏕️
      </h2>
      <p className="mt-3  text-gray-900 text-xl">
        Simply provide some basic details, and our trip planner will craft a
      ...
      <div className="mt-20 flex flex-col gap-10">
        <div>
          <h2 className="text-xl my-3 font-medium">
            What is destination of your choice✈️ ?
          </h2>
          <Input
